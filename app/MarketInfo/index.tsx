...
import { MarketInfoData, SparklineData } from "@/types/internal.types";
    ...
    <div className="bg-zinc-900 px-2">
      <div id="coins-table">
        <DataTable rows={20} scrollable lazy stripedRows loading={!coins.length} value={coins}>
          ...
          <Column body={(coin: MarketInfoData) => <Chart data={generateChartData(coin.sparkline_in_7d)} />} header="Chart 7d"></Column> */}
        </DataTable>
      </div>
    </div>
  );
